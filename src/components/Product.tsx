...
const Product = ({
    ...
    return (
        <div className="max-w-[600px] w-full flex flex-col">
            <p className="font-integral font-bold text-custom-4xl mb-3.5 max-sm:mb-3 leading-[100%]">
                {productTitle}
            </p>
            ...
            <div className="flex gap-3 mt-4">
                {SELECT_SIZE.map((item, index) => (
                    <button
                        ...
                        key={index}
                        className={`cursor-pointer bg-light-blue py-3 px-6 rounded-[62px] ${index === activeButton && "!bg-black text-white"
                            }`}
                    >
                        {item}
                    </button>
            ...
            <div className="flex gap-5">
                ...
                <button className="w-full py-[13px] bg-black text-white hover:bg-white hover:text-black">Add to Cart</button>
            </div>
        </div>
    );
};
